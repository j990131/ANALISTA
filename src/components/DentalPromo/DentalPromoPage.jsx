...
export default function DentalPromoPage() {
  ...
  return (
    <div className="promo-page">
        ...
        <div className="carousel-track">
          {products.map((product, index) => (
            <div
              ...
              aria-label={`Producto ${index + 1} de ${products.length}: ${product.name}`}
      ...
      {/* Dot indicators */}
      <div className="dots" role="tablist" aria-label="Controles de paginación de productos">
        {products.map((_, i) => (
          <button
            key={i}
            role="tab"
