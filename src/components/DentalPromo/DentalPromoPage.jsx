...
export default function DentalPromoPage() {
  ...
  return (
    <div className="promo-page">
      ...
      {/* Diagonal Carousel */}
      <div className="carousel-stage" role="region" aria-roledescription="carousel" aria-label="Dental Products">
        ...
        {/* Navigation arrows */}
        <button className="nav-btn nav-prev" onClick={prev} aria-label="Previous slide">
          ‹
        </button>
        <button className="nav-btn nav-next" onClick={next} aria-label="Next slide">
          ›
        </button>
      </div>
