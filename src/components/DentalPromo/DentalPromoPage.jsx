...
export default function DentalPromoPage() {
  ...
  return (
    <div className="promo-page">
      ...
      {/* Diagonal Carousel */}
      <div className="carousel-stage" role="region" aria-roledescription="carousel" aria-label="Productos en promoción">
        <div className="carousel-track">
          {products.map((product, index) => (
            <div
              ...
              aria-label={`Producto ${index + 1} de ${products.length}`}
            >
              <div
      ...
      {/* Dot indicators */}
      <div className="dots" role="tablist" aria-label="Seleccionar producto">
        {products.map((_, i) => (
          <button
            key={i}
