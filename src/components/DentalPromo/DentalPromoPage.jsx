...
export default function DentalPromoPage() {
  ...
  return (
    <div className="promo-page">
      ...
      {/* Diagonal Carousel */}
      <div className="carousel-stage" role="region" aria-roledescription="carousel" aria-label="Products">
        ...
        {/* Navigation arrows */}
        <button className="nav-btn nav-prev" aria-label="Previous product" onClick={prev}>
          ‹
        </button>
        <button className="nav-btn nav-next" aria-label="Next product" onClick={next}>
          ›
        </button>
      </div>
      ...
      {/* Dot indicators */}
      <div className="dots" role="tablist" aria-label="Product selection">
        {products.map((_, i) => (
          <button
            key={i}
