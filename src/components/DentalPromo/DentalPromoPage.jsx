  ...
  return (
    <div className="promo-page">
      ...
      <div className="carousel-stage">
        ...
        {/* Navigation arrows */}
        <button aria-label="Producto anterior" className="nav-btn nav-prev" onClick={prev}>
          ‹
        </button>
        <button aria-label="Producto siguiente" className="nav-btn nav-next" onClick={next}>
          ›
        </button>
      </div>
      ...
      {/* Dot indicators */}
      <div className="dots" role="tablist" aria-label="Navegación de productos">
        {products.map((_, i) => (
          <button
            key={i}
            role="tab"
