...
export default function DentalPromoPage() {
  ...
  return (
    <div className="promo-page">
      ...
      {/* Diagonal Carousel */}
      <div className="carousel-stage" role="region" aria-roledescription="carousel" aria-label="Productos promocionales">
      ...
      {/* Dot indicators */}
      <div className="dots" role="tablist" aria-label="Controles de paginación">
        {products.map((_, i) => (
          <button
            key={i}
