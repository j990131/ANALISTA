...
export default function DentalPromoPage() {
  ...
  return (
    <div className="promo-page">
      ...
      {/* Dot indicators */}
      <div className="dots" role="tablist" aria-label="Lista de productos">
        {products.map((_, i) => (
          <button
            key={i}
            role="tab" aria-selected={i === activeIndex} aria-label={`Ver producto ${i + 1}`} className={`dot ${i === activeIndex ? "dot-active" : ""}`}
